...
# import한 argparse 모듈을 사용하기 위해 ArgumentParser 객체를 생성
# formatter_class : 도움말 포매팅을 사용자 정의 할 수 있도록 한다.
# ArgumentDefaultsHelpFormatter : 기본값에 대한 정보를 각각의 인자 도움말 메시지에 자동으로 추가한다.
parser = argparse.ArgumentParser(
                    formatter_class=argparse.ArgumentDefaultsHelpFormatter)
# ArgumentParser에 인자에 대한 정보를 채우기 위해 add_argument() 메소드를 호출
# 이후 parse_args() 가 호출될 때 사용
# Data and model checkpoints directories
parser.add_argument('--data_dir', type=str, default='data/Balad_Song',
...
def train(args):
    # data_loader = TextLoader('data/tinyshakespeare', 50, 50)
    # TextLoader : utils.py 를 참고
